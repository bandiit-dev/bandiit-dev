const translationContent = {
  ...
  "pt-BR": {
    ...
    privacyContactText: "Dúvidas sobre privacidade: contato@bandiit.dev.br.",
...
export type Translations = typeof translationContent;
export type Language = keyof Translations;
export type TranslationShape = Translations[Language];
